...
/* This file is a default one, except for things marked with a 'lunr' comment */
const generateIndex = require('./generate-index') /* lunr */
...
async function generateSite (args, env) {
  ...
  const index = generateIndex(playbook, pages, contentCatalog, env) /* lunr */
  siteFiles.push(generateIndex.createIndexFile(index)) /* lunr */
